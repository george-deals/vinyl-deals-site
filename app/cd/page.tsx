...
export const metadata: Metadata = {
  title: "Top CD Deals (Amazon US) | CD Deals",
  description:
    "Top CD deals from Amazon US. Updated regularly. We track listings discounted at least 15% and surface the top savings in one place.",
};
