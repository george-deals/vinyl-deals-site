  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth="1.8"
      />
      <path d="M9.5 9.2h5v5.6h-5V9.2Z" stroke="currentColor" strokeWidth="1.8" />
    </svg>
  );
}
...
function MobilePillLink({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link
      href={href}
        ...
        <div className="flex h-16 items-center justify-between gap-4">
          <Link href="/" className="inline-flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="text-sm font-semibold text-slate-900">MediaDealsHub</div>
              <div className="text-xs text-slate-600">Daily Amazon Deals • Physical Media</div>
            </div>
          </Link>
