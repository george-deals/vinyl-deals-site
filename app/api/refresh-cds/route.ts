...
export async function GET(req: Request) {
  ...
  // CD keywords (simple for now; we can make this smarter later)
  const keywords = ["cd", "audio cd", "new cd release", "compact disc"];
  ...
  // Sort: best sellers first (lowest sales_rank), then highest discount, then newest
  all.sort((a, b) => {
