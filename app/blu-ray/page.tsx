...
export const metadata: Metadata = {
  title: "Top Blu-ray Deals (Amazon US) | Blu-ray Deals",
  description:
    "Top Blu-ray deals from Amazon US. Updated daily. We track listings discounted at least 15% and surface the top savings in one place.",
};
    ...
    <main className="min-h-screen px-6 py-10">
      <div className="mx-auto max-w-6xl">
        <div className="flex items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold">Top Blu-ray Deals</h1>
            <p className="mt-2 text-slate-600">
              Blu-ray deals from Amazon US. Data appears after the refresh job runs.
            </p>
          </div>
