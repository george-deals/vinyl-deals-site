...
export const metadata: Metadata = {
  title: "Vinyl Under $20 (Amazon US) | MediaDealsHub",
  description: "Vinyl records under $20 on Amazon US. Updated regularly. Best sellers first.",
  alternates: { canonical: "/vinyl/under-20" },
...
export default async function VinylUnder20Page() {
...
.eq("media_type", "vinyl")
  ...
  <h1 className="text-3xl font-bold">Vinyl Under $20</h1>
    ...
    Last Updated: <strong>{lastUpdatedIso ? formatPT(lastUpdatedIso) : "—"}</strong>
        ...
        {error ? (
          ...
          <div className="mt-6 rounded-lg border bg-white p-6">
            <p className="text-slate-700">No results yet under $20.</p>
          </div>
        ) : (
          <>
