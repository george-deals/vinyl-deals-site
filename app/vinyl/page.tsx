...
export const metadata: Metadata = {
  title: "Top Vinyl Deals (Amazon US) | Vinyl Deals",
  description:
    "Top vinyl record deals from Amazon US. Updated daily. We track listings discounted at least 15% and surface the top savings in one place.",
};
    ...
    <main className="min-h-screen px-6 py-10">
      <div className="mx-auto max-w-6xl">
        <div className="flex items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold">Top Vinyl Deals</h1>
            <p className="mt-2 text-slate-600">
              Vinyl record deals from Amazon US. Data appears after the refresh job runs.
            </p>
          </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-2 text-sm">
                          ...
                          {list ? (
                            <span className="text-slate-500 line-through">{list}</span>
                          ) : null}
